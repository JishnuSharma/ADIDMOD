    ...
    return (
        <div>
            <div className="flex justify-between items-center mt-6 px-10">
                ...
                <div className="bg-purple-200 p-3 rounded-2xl hover:bg-purple-400 hover:text-white transition duration-500 text-purple-800 flex items-center gap-2 group cursor-pointer" onClick={() => setShowInstructions(true)}>
                    ...
                    <svg
                        ...
                        height="24"
                        viewBox="0 0 50 50"
                        className="fill-current text-purple-800 group-hover:text-white transition duration-300"
                    >
